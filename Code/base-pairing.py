...
def Base_plane(base, coords, cent_coor1, cent_coor2):
    ...
    try:
        ...
        Z = np.linalg.norm(cent_coor2 - point_coord)   # 垂直距离，是否共面
        D = np.linalg.norm(cent_coor1 - point_coord)  # 碱基之间的距离
